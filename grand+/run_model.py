...
if __name__ == '__main__':
    ...
    parser.add_argument('--stop_mode', type=str,
        default='both', help="acc, loss, both")
    ...
    parser.add_argument('--order', type=int, default=10, help='prop num')
    ...
    parser.add_argument('--log', type=bool,
                        default=False, help="acc, loss, both")
    ...
    for s1 in range(l1):
        ...
        for s2 in range(l2):
            args.seed2 = s2
            t_total, test_acc, batch_time_av, batch_num = main_grandpp(args)
